    ...
    return (
        <div>
            ...
            <table className="table">
                ...
                <tr>
                    <td>
                        <input value={user.username} placeholder={'Username'} className={'form-control'} onChange={(e) => setUser({ ...user, username: e.target.value })}/>
                        <input className={'form-control'} placeholder={'Password'} type={'password'} value={user.password} onChange={(e) => setUser({ ...user, password: e.target.value })}/>
